...
class PiecewiseLinearInletOutletEnv2d(EnvBase):
    def __init__(self, seed, folder, cell_dim = (20, 20), youngs_modulus = 100,
                 poissons_ratio = 0.499, volume_tolerance = 1e-3, inlets = [[0.125, 0.875]], outlets = [[0.125, 0.875]], inlet_velocities = [[1., 0.]],
        ...
        print(len(bounds), len(num_pieces))
